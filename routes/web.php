...
Route::prefix('/brand')->group(function(){
	...
	Route::get('detailsdo','BrandController@detailsdo');
	Route::get('goodslist','BrandController@goodslist');
	Route::get('goodscar/{id}','BrandController@goodscar');
...
Route::prefix('/article')->middleware('checklogin')->group(function(){
	...
	Route::get('xiang/{id}','ArticleController@xiang');
});
Auth::routes();
...
Route::prefix('/')->group(function(){
	...
	Route::get('/pcalipay/{id}','Index\IndexController@pcalipay');
	Route::get('/phonealipay/{id}','Index\IndexController@phonealipay');

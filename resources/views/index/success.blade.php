...
<html lang="zh-cn">
  ...
  <body>
    ...
    <div class="gwcpiao">
     <table>
      <tr>
       <td width="30%"><a href="prolist.html" class="jiesuan" style="background:#5ea626;">继续购物</a></td>
       <td width="70%" ><a href="/pcalipay/{{$res->order_id}}" class="jiesuan">PC端支付</a><a href="/phonealipay/{{$res->order_id}}" class="jiesuan">手机端支付</a></td>
      </tr>
     </table>
    </div><!--gwcpiao/-->
    </div><!--maincont-->
